...
perms[ENABLE_CERTIFICATE_GENERATION] = is_staff | HasAccessRule('staff')
perms[GENERATE_CERTIFICATE_EXCEPTIONS] = is_staff | HasAccessRule('staff')
perms[GENERATE_BULK_CERTIFICATE_EXCEPTIONS] = is_staff | HasAccessRule('staff')
...
perms[CAN_RESEARCH] = is_staff | HasRolesRule('data_researcher') | HasAccessRule('staff') | HasAccessRule('instructor')
