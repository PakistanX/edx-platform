    ...
    this.DiscussionUtil = (function() {
        ...
        DiscussionUtil.urlFor = function(name, param, param1, param2) {
            return {
                ...
                undo_downvote_for_thread: '/courses/' + $$course_id + '/discussion/threads/' + param + '/undownvote',
                ...
                undo_downvote_for_comment: '/courses/' + $$course_id + '/discussion/comments/' + param + '/undownvote',
