...
def course_image_change(sender, instance, **kwargs):  # pylint: disable=unused-argument
    ...
    if instance.course_image_url.endswith('images_course_image.jpg') or ('/studio/' in instance.course_image_url and
                                                                         instance.course_image_url.endswith(
                                                                             settings.DEFAULT_COURSE_ABOUT_IMAGE_URL)):
